...
Practice tests covered maybe 70% of what actually showed up. The exam leaned heavily on the core services: EC2, ECS, Lambda, Elastic Beanstalk, Athena, Kinesis, EBS, S3, Auto Scaling, Route 53, IAM, DynamoDB, RDS, KMS, SQS, SNS, the developer tools, API Gateway, VPC, EFS, Glacier, and more.

I finished in about an hour and spent the second hour going back over every question. The exam isn't really testing whether you know what a service does — it's testing whether you know how several of them fit together in a real scenario. That only comes from actually building things, not just reading about them.
...
- Digital Cloud Training's certification resources
- The AWS FAQs and the Cloud Best Practices / Security Best Practices whitepapers
- The AWS Certifications subreddit, for the "did anyone else get asked about X" sanity checks
